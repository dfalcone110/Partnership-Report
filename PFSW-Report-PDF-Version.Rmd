...
knitr::opts_chunk$set(echo = TRUE, include = FALSE, message = FALSE, warning = FALSE, fig.pos = "H", out.extra = "")
...
**`r currentmonthlabel` `r year` had `r numless0.5` samples below 0.50 mg/l throughout the distribution system, and `r numless1` samples below 1 mg/l.**
